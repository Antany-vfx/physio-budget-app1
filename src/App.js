...
function MonthlyPhysioApp() {
  const pages = ["Physiotherapist List", "Setup", "Monthly Summary", "Visual Chart"];
  ...
  const renderCurrentPage = () => {
    ...
    if (currentPage === "Flow Chart") return renderFlowChart();
  ...
  const renderVisualChart = () => {
    ...
    const chartData = [
      { label: 'Income', value: totalRate },
      { label: 'Fuel', value: totalFuel },
      { label: 'Salary', value: totalSalary },
      { label: 'Fixed Costs', value: totalFixed }
    ];
